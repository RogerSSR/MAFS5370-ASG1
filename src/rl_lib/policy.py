...
from src.rl_lib.distribution import Choose , Constant , Distribution , FiniteDistribution
...
class Policy ( ABC , Generic [ S , A ] ):
    ...
    def act ( self , state: NonTerminal [ S ] ) -> Distribution [ A ]:
        '''
        A distribution of actions to take from the given non-terminal state.
        '''
...
class FiniteDeterministicPolicy ( FinitePolicy [ S , A ] ):
    '''
    A deterministic policy where the state and action spaces are finite.
    '''
